...
<div className="bSell flex gap-3 items-center ">
    ...
    <p className='font-semibold text-base md:text-base' >OUR BESTSELLERS</p>
</div>

<div className="Lattext text-3xl my-3 lg:text-5xl prata">Latest Arrivals</div>
<div className="flex gap-3 items-center ">
    <p className='font-semibold text-base md:text-base ' >SHOP NOW</p>
    <p className='bg-[#414141] w-8 md:w-11 h-[2px] '></p>
</div>
      </div>
